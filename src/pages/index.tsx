    ...
    <>
      ...
      <main className="container bg-slate-400 flex flex-col items-center justify-center min-h-screen min-w-full">
        ...
        <input onChange={(e) => {
          ...
          setIsCopied(false)
        }} value={link} className='h-10 mb-4 p-4 rounded-xl w-1/2' placeholder="Paste your link here..." />
        <button className="bg-slate-600 outline-2 rounded p-4 text-white mb-4" onClick={() => {
